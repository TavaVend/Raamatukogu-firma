...
Alpine Linux on väike ja kerge operatsioonisüsteem mis sobib ideaalselt lihtsa ülesande jaoks nagu varundamine. See ei tarbi palju mälu ega ressursse - täpselt see mida vaja backup teenuse jaoks. Alpine käivitab meie `backup.sh` skripti iga päev automaatselt, mis kopeerib kõik Manager.io andmed eraldi salvestuskohta ja hoiab neid 7 päeva.
