...
[Kasutaja brauser]
 ...
 [Manager.io konteiner]
   ...
   [manager_data]
        |
   [Alpine Linux backup konteiner] → [backup_data]
```
...
### Alpine Linux (Backup teenus)
- Kerge ja lihtne operatsioonisüsteem varukoopiate jaoks
- Käivitab `backup.sh` skripti iga päev automaatselt
- Loeb andmed `manager_data` volume'ist
